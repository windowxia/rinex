...
The default workspace is rinex-cli/workspace"))
                ...
                .next_help_heading("Data generation")
                    .arg(Arg::new("gzip")
                        .long("gzip")
                        .action(ArgAction::SetTrue)
                        .help("Active Gzip compression. All generated RINEX will be gzip compressed"))
                    .arg(Arg::new("crx")
                        .long("crx")
                        .action(ArgAction::SetTrue)
                        .help("Active CRINEX compression. All generated OBS RINEX will be compressed. You can combine it to --gzip."))
					.arg(Arg::new("gpx")
						.long("gpx")
                        .action(ArgAction::SetTrue)
